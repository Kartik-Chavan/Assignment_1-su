...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 animate-fade-in">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center animate-slide-up">
          ...
          <p className="text-gray-600">Sign in to your TechFlow account</p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
          {isLoggedIn ? (
            <div className="text-center animate-fade-in">
              ...
              <h3 className="text-xl font-semibold text-green-800 mb-2">Login Successful!</h3>
              <p className="text-green-600">Welcome back to TechFlow Solutions.</p>
            </div>
          ) : (
